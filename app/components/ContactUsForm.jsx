...
const ContactUsForm = () => {
  return (
    <div>
      <div className="flex flex-col lg:flex-row max-w-7xl mx-auto  lg:mb-15 w-full">
        ...
        <div className="w-full h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px] xl:h-[700px] max-w-none">
          <iframe
